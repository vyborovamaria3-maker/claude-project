...
export default function CTOStep5({ onBack, onLaunch }: Props) {
  return (
    <div className="space-y-6">
      <div className="glass p-5 rounded-2xl space-y-4">
        <h2 className="text-sm font-semibold text-white">Review & Launch</h2>
        <p className="text-xs text-white/40">Step 5 — review all settings and launch (coming soon)</p>
      </div>
