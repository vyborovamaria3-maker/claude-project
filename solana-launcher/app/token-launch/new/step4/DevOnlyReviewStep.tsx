...
// data-tag: token_launch.new.step4.dev_only
export default function DevOnlyReviewStep({ data, update, next, prev }: StepProps) {
  ...
  return (
    <div data-tag="token_launch.new.step4.dev_only" className="space-y-6">

      {/* ── Dev Buy Settings ── */}
      <div className="space-y-3">
        <h2 className="text-base font-semibold text-white">Dev Buy Settings</h2>
        <div className="glass p-4 space-y-2">
          ...
          <p className="text-xs text-white/40 leading-relaxed mt-1">
            Derived from the dev wallet amount on Step 3. Only the dev wallet will purchase tokens at launch.
          </p>
        </div>
      </div>
