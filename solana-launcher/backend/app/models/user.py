...
class User(Base):
    ...
    access_login: Mapped[str | None] = mapped_column(
        String(32),
        unique=True,
        index=True,
        nullable=True,
    ...
    telegram_language_code: Mapped[str | None] = mapped_column(
        String(32),
        nullable=True,
    )
    telegram_is_premium: Mapped[bool | None] = mapped_column(
        Boolean,
        nullable=True,
    )
    telegram_added_to_attachment_menu: Mapped[bool | None] = mapped_column(
        Boolean,
        nullable=True,
    )
    telegram_allows_write_to_pm: Mapped[bool | None] = mapped_column(
        Boolean,
        nullable=True,
    )
