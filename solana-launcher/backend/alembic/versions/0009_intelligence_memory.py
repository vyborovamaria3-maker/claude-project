...
def upgrade() -> None:
    ...
    op.create_index(
        "ix_intelligence_snapshots_mint_created",
        "intelligence_snapshots",
        ["mint_address", "created_at"],
    )
    op.create_index(
        "ix_intelligence_snapshots_created",
        "intelligence_snapshots",
        ["created_at"],
    )
    ...
    op.create_index(
        "ix_intelligence_entities_type_last",
        "intelligence_entities",
        ["entity_type", "last_seen_at"],
    )
    op.create_index(
        "ix_intelligence_entities_label",
        "intelligence_entities",
        ["label"],
    )
    ...
    op.create_table(
        ...
        sa.Column(
            ...
            sa.ForeignKey("intelligence_snapshots.snapshot_id", ondelete="CASCADE"),
            nullable=False,
        ),
        sa.Column("entity_key", sa.String(length=160), nullable=False),
        sa.Column("entity_type", sa.String(length=32), nullable=False),
    ...
    op.create_index(
        "ix_intelligence_edges_source",
        "intelligence_edges",
        ["source_key", "last_seen_at"],
    )
    op.create_index(
        "ix_intelligence_edges_target",
        "intelligence_edges",
        ["target_key", "last_seen_at"],
    )
    op.create_index(
        "ix_intelligence_edges_type",
        "intelligence_edges",
        ["edge_type", "last_seen_at"],
    )

    op.create_table(
        "intelligence_snapshot_edges",
        sa.Column("id", sa.Integer(), primary_key=True),
        sa.Column(
            "snapshot_id",
            sa.String(length=160),
    ...
    op.create_index(
        "ix_intelligence_discoveries_snapshot",
        "intelligence_discoveries",
        ["snapshot_id"],
    )
    op.create_index(
        "ix_intelligence_discoveries_source",
        "intelligence_discoveries",
        ["source_key", "created_at"],
    )
    op.create_index(
        "ix_intelligence_discoveries_target",
        "intelligence_discoveries",
        ["target_key", "created_at"],
    )
    op.create_index(
        "ix_intelligence_discoveries_type",
        "intelligence_discoveries",
        ["discovery_type", "created_at"],
    )


def downgrade() -> None:
    op.drop_table("intelligence_discoveries")
    op.drop_table("intelligence_snapshot_edges")
