...
def upgrade() -> None:
    ...
    op.create_index(
        "ix_intelligence_narrative_last",
        "intelligence_narrative_memory",
        ["last_seen_at"],
    )
...
def downgrade() -> None:
    op.drop_index(
        "ix_intelligence_narrative_last",
        table_name="intelligence_narrative_memory",
    )
    op.drop_table("intelligence_narrative_memory")
    op.drop_index(
        "ix_intelligence_calibration_signal",
        table_name="intelligence_calibration_stats",
    )
    op.drop_table("intelligence_calibration_stats")
    op.drop_index(
        "ix_intelligence_outcomes_mint_horizon",
        table_name="intelligence_outcomes",
    )
    ...
    op.drop_index(
        "ix_campaign_fingerprints_hash",
        table_name="campaign_fingerprints",
    )
    op.drop_index(
        "ix_campaign_fingerprints_mint_created",
        table_name="campaign_fingerprints",
